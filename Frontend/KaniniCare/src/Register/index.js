...
<h5 class="section-title h1">Register</h5>
    <div class="container">
        <div class="row">
                    ...
                    <div class="mainflip">
                        ...
                        <div class="backside">
                            <div class="card">
                                ...
                                <button /*onClick={() => navigation(routeName.SignUpAdmin)}*/ className="btn-success"><Link to="/registerAdmin" className="btn-success">Proceed</Link></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mainflip">
                        ...
                        <div class="backside">
                            <div class="card">
                                ...
                                <button /*onClick={() => navigation(routeName.SignUpDoctor)}*/ className="btn-success"><Link to="/registerDoctor" className="btn-success">Proceed</Link></button>
                    ...
                    <div class="mainflip">
                        ...
                        <div class="backside">
                            <div class="card">
                                ...
                                <button /* onClick={() => navigation(routeName.SignUpPatient)} */ className="btn-success"><Link to="/registerPatient" className="btn-success">Proceed</Link></button>
                            </div>
                        </div>
                    </div>
                </div>
