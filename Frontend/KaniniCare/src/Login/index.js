                    ...
                    <div class="mainflip">
                        ...
                        <div class="backside">
                            <div class="card">
                                ...
                                <button className="btn-success">Proceed</button>
                    ...
                    <div class="mainflip">
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title">Doctor</h4>
                                    <p class="card-text">Doctorr meets the patients, examining them and discussing their symptoms and medical histories & performing surgical procedures also providing pre- and post-operative care.</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a class="social-icon text-xs-center" target="_blank" href="#">
                                                <i class="fa fa-facebook"></i>
